...
public class NonIntrusiveService extends Service {
    ...
    private void showNonIntrusive() {
        ...
        // get the height of our card to use it later
        ...
        // setup proper gravity
        params.gravity = Gravity.BOTTOM | Gravity.CENTER_HORIZONTAL;
        // and dont forget about the width and height, else we end up with a fullscreen
    ...
    private void bindActions(final LinearLayout rootView) {
        ...
        // Setup a touch listener to be able to drag the dialog around
        // TODO: improve it
